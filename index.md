...
SAIL Research Group is led by [Haiyu Mao](https://hybol1993.github.io/).  We are part of the [Department of Engineering](https://www.kcl.ac.uk/engineering) at [King's College London](https://www.kcl.ac.uk/).

Our Mission: We co-design software (algorithms) and hardware (architectures) to power data-intensive AI and bioinformatics for healthier, simpler everyday life.
